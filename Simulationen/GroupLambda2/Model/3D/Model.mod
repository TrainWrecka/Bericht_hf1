...
'@ new component: DipoleX

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Component.New "DipoleX" 


'@ define cylinder: DipoleX:AntennaX
...
'@ define cylinder: DipoleX:Vacuum1
...
'@ delete shape: DipoleX:Vacuum1

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Solid.Delete "DipoleX:Vacuum1" 


'@ new component: DipoleY

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Component.New "DipoleY" 


'@ define cylinder: DipoleY:AntennaY
...
'@ boolean insert shapes: DipoleX:AntennaX, Vacuum:Vacuum

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Solid.Insert "DipoleX:AntennaX", "Vacuum:Vacuum" 

'@ boolean insert shapes: DipoleY:AntennaY, Vacuum:Vacuum

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Solid.Insert "DipoleY:AntennaY", "Vacuum:Vacuum" 
...
With DiscretePort 
     ...
     .Voltage "1.0" 
     .Current "1.0" 
     .SetP1 "False", "-0.2", "0.0", "0.0" 
     .SetP2 "False", "0.2", "0.0", "0.0" 
     .InvertDirection "False" 
     .LocalCoordinates "False" 
     .Monitor "True" 
     .Radius "0.0" 
...
With DiscretePort 
     ...
     .Voltage "1.0" 
     .Current "1.0" 
     .SetP1 "False", "0.0", "-0.2", "0.0" 
     .SetP2 "False", "0.0", "0.2", "0.0" 
     .InvertDirection "False" 
     .LocalCoordinates "False" 
     .Monitor "True" 
     .Radius "0.0" 
...
With Solver 
     ...
     .SimultaneousExcitation "True" 
     .SetSimultaneousExcitAutoLabel "True" 
     .SetSimultaneousExcitationLabel "1[1.0,0.0]+2[1.0,90],[1]" 
     .SetSimultaneousExcitationOffset "Phaseshift" 
     .PhaseRefFrequency "1" 
     .ExcitationSelectionShowAdditionalSettings "False" 
     .ExcitationPortMode "1", "1", "1.0", "0.0", "default", "True" 
