...
'@ delete shape: Dipole1:Vacuum1

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Solid.Delete "Dipole1:Vacuum1"

'@ delete shape: Dipole2:Vacuum2

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Solid.Delete "Dipole2:Vacuum2"
...
'@ boolean insert shapes: Dipole2:Antenna2, Vacuum:Vacuum

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Solid.Insert "Dipole2:Antenna2", "Vacuum:Vacuum"

'@ boolean insert shapes: Dipole1:Antenna1, Vacuum:Vacuum

'[VERSION]2018.6|27.0.2|20180615[/VERSION]
Solid.Insert "Dipole1:Antenna1", "Vacuum:Vacuum"
...
With Solver 
     ...
     .SimultaneousExcitation "True" 
     .SetSimultaneousExcitAutoLabel "True" 
     .SetSimultaneousExcitationLabel "1[1.0,90]+2[1.0,0.0],[1]" 
     .SetSimultaneousExcitationOffset "Phaseshift" 
     .PhaseRefFrequency "1" 
     .ExcitationSelectionShowAdditionalSettings "False" 
     .ExcitationPortMode "1", "1", "1.0", "90", "default", "True" 
     .ExcitationPortMode "2", "1", "1.0", "0.0", "default", "True" 
End With
...
With Monitor 
     ...
     .UseSubvolume "False" 
     .Coordinates "Structure" 
     .SetSubvolume "-150", "150", "-150", "150", "-0.2", "0.2" 
...
With Solver 
     ...
     .SimultaneousExcitation "True" 
     .SetSimultaneousExcitAutoLabel "True" 
     .SetSimultaneousExcitationLabel "1[1.0,0]+2[1.0,0.0],[1]" 
     .SetSimultaneousExcitationOffset "Phaseshift" 
     .PhaseRefFrequency "1" 
     .ExcitationSelectionShowAdditionalSettings "False" 
     .ExcitationPortMode "1", "1", "1.0", "0", "default", "True" 
     .ExcitationPortMode "2", "1", "1.0", "0.0", "default", "True" 
End With 
